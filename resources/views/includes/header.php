<!DOCTYPE html>
	...
	<head>
        ...
        <link rel="shortcut icon" href="{{asset('img/logo3.png')}}">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('img/logo3.png')}}">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('img/logo3.png')}}">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('img/logo3.png')}}">
        <link rel="apple-touch-icon-precomposed" href="{{asset('img/logo3.png')}}">
				...
				<nav class="navbar navbar-expand-lg  navbar-light">
					<div class="container-fluid">
						  <div class="collapse navbar-collapse align-items-center" id="navbarSupportedContent">
						    <ul class="navbar-nav">
								<a class=" " href="#home"> 
									<img src={{ __('body.logo') }} alt="" width="135">
									
								</a>
							</ul>
							<ul class="navbar-nav">
								<li><a href="#account_service">{{ __('body.account_service') }}</a></li>
								<li><a href="#electronic_service">{{ __('body.electronic_service') }}</a></li>
								<li><a href="#courses">{{ __('body.courses') }}</a></li>
								<li><a href="#aboutUs">{{ __('body.aboutUs') }}</a></li>
								<li><a href="#footer">{{ __('body.branshes') }}</a></li>
								<li><a href="#footer">{{ __('body.contacts') }}</a></li>
								<li><a href="#">{{ __('body.applicant') }}</a></li>
							  </ul>
						  </div>						
					</div>
				</nav>
